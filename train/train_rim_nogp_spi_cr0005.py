...
def main() -> None:
    ...
    parser.add_argument("--encoder-checkpoint", type=Path,
                        default=Path("results/encoder_spi_mnist32_cr_5e-3_e500_bs128_lr_1e-3_z128_ch64/encoder.pt"))
    ...
    parser.add_argument("--cr", type=float, default=0.005)
    parser.add_argument("--scale", type=int, default=-1)
    parser.add_argument("--measurement-noise-std", type=float, default=0.0)
    parser.add_argument("--use-generator-prior", action=argparse.BooleanOptionalAction, default=False)
    parser.add_argument("--rim-init-mode", type=str, default="backprojection",
